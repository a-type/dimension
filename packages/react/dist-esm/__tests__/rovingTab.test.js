    ...
    it('can select via keyboard on a vertical list', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    onChange = jest.fn();
                    result = render(React.createElement(RovingTabContainer, { onChange: onChange },
                        React.createElement(RovingTabItem, { value: "0", "data-testid": "item-0" }, "0"),
                        React.createElement(RovingTabItem, { value: "1", "data-testid": "item-1" }, "1"),
                        React.createElement(RovingTabItem, { value: "2", "data-testid": "item-2" }, "2")));
                ...
                case 4:
                    _a.sent();
                    return [4 /*yield*/, wait(function () {
                            expect(result.getByTestId('item-1')).toHaveAttribute('aria-checked', 'true');
                        })];
                case 5:
                    _a.sent();
                    act(function () {
...
//# sourceMappingURL=rovingTab.test.js.map