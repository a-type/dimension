import { Ref, KeyboardEventHandler } from 'react';
import { KeyActions } from '@dimension/core';
export declare type UseSelectionFocusElementOptions = {
    /**
...
export declare type UseSelectionFocusElementReturn = {
 ...
 */
export declare type SelectionFocusElementProvidedProps = {
    onKeyDown: KeyboardEventHandler<any>;
    ref: Ref<any>;
    id: string;
 ...
 * @category Selection
 */
export declare const useSelectionFocusElement: (options: UseSelectionFocusElementOptions) => UseSelectionFocusElementReturn;
